...
public:
    ...
    int findContentChildren(vector<int>& g, vector<int>& s) {
        ...
        while (i < g.size() && j < s.size()) {
            if (s[j] >= g[i]) {  // Greedy Choice - Enough Cookies for Child
...
int main() {
    ...
    // (greed_factors, cookies, expected)
    ...
    vector<int (AssignCookies::*)(vector<int>&, vector<int>&)> funcs = {
        &AssignCookies::findContentChildren,
    };
