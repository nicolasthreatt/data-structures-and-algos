...
public:
    ...
    int largestSumAfterKNegationsI(vector<int>& nums, int k) {
...
int main() {
    MaxSumAfterKNegations Solution;
    ...
    vector<int (MaxSumAfterKNegations::*)(vector<int>&, int)> funcs = {
        &MaxSumAfterKNegations::largestSumAfterKNegationsI,
    };
